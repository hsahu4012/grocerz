...
const Subcategory = () => {
  ...
  const url =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo5Q9zUcW2xzPpC56YtkwJbh9A95a9P6MFgQ&usqp=CAU';
  ...
  const subcategory = async id => {
    try {
      const url = await fetch(
        `${process.env.REACT_APP_API_URL}products/bySubCategoryId/:001`
      );

      ...
      <header id="header" class="header">
              ...
              {/* <div class="header-search-btn">
                ...
                <div id="allcat">
                  ...
                  <div class="slectbox-body" style={{ display: "none" }}>
                    <div
                      class="clickAway position-fixed"
                      onclick="selectBoxHandler('allcat')"
                    ></div>
                    <ul class="country-options">
                      <li class="all-option">
                        <span class="option-text item-text">Vegetable</span>
                      </li>
                      <li class="all-option">
                        <span class="option-text item-text">Fruits</span>
                      </li>
                      <li class="all-option">
                        <span class="option-text item-text">Juice</span>
                      </li>
                      <li class="all-option">
                        <span class="option-text item-text">Meat</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <nav class="mobile-menu d-block d-lg-none">
          <div class="mobile-menu-header d-flex justify-content-between align-items-center">
            ...
            <Link to="/home" class="mobile-header-logo">
              <img src={logo} alt="logo" className="logo-image" />
            </Link>
                            ...
                            <div class="dropdown-list-item d-flex">
                              <span class="dropdown-img">
                                ...
                                {/* <svg
                                  ...
                                  data-prefix="fas"
                                  data-icon="anchor"
                                  class="svg-inline--fa fa-anchor w-4 h-4"
                                  role="img"
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 576 512"
                                >
                              ...
                              <span class="dropdown-text">{item.categoryname}</span>
                            </div>
                    ...
                    <a href="product-sidebar.html">
                      <div class="dropdown-item d-flex justify-content-between align-items-center">
                        <div class="dropdown-list-item d-flex">
                          ...
                          <span class="dropdown-text">Vegetable</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              data-prefix="fas"
                              data-icon="gamepad"
                              class="svg-inline--fa fa-gamepad w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 640 512"
                            >
                          ...
                          <span class="dropdown-text">Fruits</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                    ...
                    <a href="product-sidebar.html">
                      <div class="dropdown-item d-flex justify-content-between align-items-center">
                        <div class="dropdown-list-item d-flex">
                          ...
                          <span class="dropdown-text">Juice</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              data-prefix="fas"
                              data-icon="house"
                              class="svg-inline--fa fa-house w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 576 512"
                            >
                          ...
                          <span class="dropdown-text">Meat</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              class="svg-inline--fa fa-basketball w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 512 512"
                            >
                          ...
                          <span class="dropdown-text">Smoothie</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              data-prefix="fas"
                              data-icon="bicycle"
                              class="svg-inline--fa fa-bicycle w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 640 512"
                            >
                          ...
                          <span class="dropdown-text">Bread</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              class="svg-inline--fa fa-street-view w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 512 512"
                            >
                          ...
                          <span class="dropdown-text">Sea Food</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              data-prefix="fab"
                              data-icon="android"
                              class="svg-inline--fa fa-android w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 576 512"
                            >
                          ...
                          <span class="dropdown-text">Pet Food</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                    ...
                    <a href="product-sidebar.html">
                      <div class="dropdown-item d-flex justify-content-between align-items-center">
                        <div class="dropdown-list-item d-flex">
                          ...
                          <span class="dropdown-text">Milk & Drinks</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
                        ...
                        <div class="dropdown-list-item d-flex">
                          <span class="dropdown-img">
                            <svg
                              ...
                              data-prefix="fas"
                              data-icon="gears"
                              class="svg-inline--fa fa-gears w-4 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 640 512"
                            >
                          ...
                          <span class="dropdown-text">Protein</span>
                        </div>
                        <div class="drop-down-list-icon">
                          <span>
                            <svg
          ...
          <div class="container">
            <div class="header-nav">
              <div class="header-nav-menu-section">
                <div class="category-menu-section position-relative" onClick={tooglmenu}>
                  ...
                  <div class="category-dropdown position-absolute" id="subMenu">
                    <ul class="category-list">
                      {
                        category && category.map((item, index) => (
                          <li class="category-list-item" key={index + 'grocji'}>
                            <Link to={`/category/${item.category_id}`}>
                              <div class="dropdown-item d-flex justify-content-between align-items-center">
                                <div class="dropdown-list-item d-flex">
                                  <span class="dropdown-img">
                                    <img src={item.image} alt="cat image" />
                                    {/* <svg
                                     aria-hidden="true"
                                     focusable="false"
                                     data-prefix="fas"
                       ...
                       <Link to="/category/attar23346">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Atta, Rice, Oil and Dal</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/babyc42146">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Baby Care</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/bath,26350">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Bath, Body & Hair</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/biscu15589">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Biscuits & Cookies</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/break52600">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Breakfast & Sauces</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/clean10142">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Cleaning Essentials</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/coldd37594">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Cold Drinks & Juices</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/dairy64076">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Dairy, Bread & Eggs</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/froze52579">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Frozen Food & Ice Creams</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/fruit20420">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Fruits and vegetables</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/groom1229">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Grooming Essentials</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/homen70647">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Home Needs</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/hygie19570">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Hygiene & Wellness</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/makeu93103">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Makeup</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/masal73543">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Masala & Dry Fruits</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/meats80643">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Meats, Fish & Eggs</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/munch23538">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Munchies & Chips</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/packa64266">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Packaged Food</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/skinc16134">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Skincare</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/sweet36873">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Sweet Cravings</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                        ...
                        <Link to="/category/teaco55536">
                          <div class="dropdown-item d-flex justify-content-between align-items-center">
                            <div class="dropdown-list-item d-flex">
                              ...
                              <span class="dropdown-text">Tea, Coffee & Health Drinks</span>
                            </div>
                            <div class="drop-down-list-icon">
                              <span>
                                <svg
                  ...
                  <ul class="menu-list">
                      ...
                      <div class="shop-menu">
                        <div class="menu-wrapper">
                          <div class="menu-list">
                            ...
                            <ul>
                              <li>
                                <a href="product-sidebar.html">Shirt</a>
                              </li>
                              <li>
                                <a href="product-sidebar.html">Skart</a>
                              </li>
                              <li>
                                <a href="product-sidebar.html"> T-Shirt</a>
                              </li>
                            </ul>
                          </div>
                          <div class="menu-list">
                            ...
                            <ul>
                              <li>
                                <a href="product-sidebar.html">HandBags</a>
                              </li>
                              <li>
                                <a href="product-sidebar.html">Mobile Bags</a>
                              </li>
                              <li>
                                <a href="product-sidebar.html">School Bags</a>
                              </li>
                            </ul>
                          </div>
                          <div class="menu-list">
                            ...
                            <ul>
                              <li>
                                <a href="product-sidebar.html">Liptics</a>
                              </li>
                              <li>
                                <a href="product-sidebar.html">Foundation</a>
                              </li>
                              <li>
                                <a href="product-sidebar.html"> Eye Liner</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                        <div class="shop-menu-img">
                          <img
                            src="assets/images/homepage-one/empty-wishlist.webp"
                            alt="img"
                          />
                        </div>
                      </div>
                    ...
                    {/* <li>
                      ...
                      <ul class="header-sub-menu">
                        <li>
                          <a href="product-info.html">Product-details</a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="product-sidebar.html">Shop Category Icon</a>
                        </li>
                        <li>

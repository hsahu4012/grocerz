        ...
        <div class="header-bottom d-lg-block d-none">
            ...
            <div class="offcanvas-menu-wrapper">
                ...
                <ul class="offcanvas__widget">
                    ...
                    <li><Link to="/wishlist"><span class="icon_heart_alt"></span>
                        <div class="tip">2</div>
                    </Link></li>
                    <li><Link to="/cart"><span class="icon_bag_alt"></span>
                        <div class="tip">2</div>
                    </Link></li>
                </ul>
            ...
            <header class="header">
                <div class="container-fluid">
                    ...
                    <li key={category.category_id}>
                      <Link to={`/category/${formatcategoryName(category.categoryname)}/${category.category_id}`}>{category.categoryname}</Link>
                    </li>
                  ))}

                                    
                                    <li><Link to="/product/1111">Product</Link></li>
                            ...
                            <div class="header__right">
                                 ...
                                 {appstate.loginstatus ? (
                                    <div className="header__right__auth">
                                        <nav class="header__menu logged-header" style={{float: 'left'}}>
                                        <ul>
                                            <li><a href="#">Profile</a>
                                                <ul class="dropdown">
                                                    ...
                                                    <li><Link to="./addresslist">Address</Link></li>

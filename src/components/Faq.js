        ...
        <div className='container'>
          <div className='row gy-5'>
            <div className='col-lg-6'>
              <div
                className='faq-accordion accordion accordion-flush'
                id='accordionFlushExample'
                data-aos='fade-right'
              >
                <h5>Frequently Asked Questions</h5>
                <div className='faq-item accordion-item box-shadows'>
                    ...
                    >
                      ...
                      <span className='plus'>
                        <svg
                          ...
                          class='fill-current text-qpurple'
                        >
                  ...
                  >
                    <div className='accordion-body'>
                      <span className='paragraph'>
                        ...
                        around the world. However, shipping times and fees may
                        vary depending on your location. Please check our
                        shipping policy page for more information about
                  ...
                  >
                    <div className='accordion-body'>
                      <span className='paragraph'>
                        ...
                        purchase, so we offer a hassle-free return policy. If
                        you are not satisfied with your purchase, you can return
                        it within a certain timeframe for a refund or exchange.
                  ...
                  >
                    <div className='accordion-body'>
                      <h5 className='paragraph'>
                        ...
                        and debit cards, PayPal, and other third-party payment
                        platforms. All payments are processed securely to ensure
                ...
                <div className='faq-item accordion-item box-shadows'>
                  ...
                  >
                    <div className='accordion-body'>
                      <h5 className='paragraph'>
                        Once your order has been shipped, we will provide you
                        with a tracking number that you can use to track your
                        package. You can use this number to track your package
                        on our website or through the carrier's website.
                      </h5>
                    </div>
                  </div>
                </div>
                <div className='faq-item accordion-item box-shadows'>
                  ...
                  >
                    <div className='accordion-body'>
                      <h5 className='paragraph'>
                        To place an order on our website, simply browse our
                        products and add the items you want to your cart. Once
                        you are ready to checkout, follow the prompts to enter
                        your shipping and payment information. Once your order
                        is confirmed, we will process and ship it to you as soon
                        as possible.
                      </h5>
                    </div>
                  </div>
            ...
            <div class='login-btn'>
              <Link to='/contact'>
                ...
                >
                  For any doubts or queries <br></br>Contact us
                </button>
              </Link>
            </div>

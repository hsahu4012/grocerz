            ...
            >
                      ...
                      <div className=" account-section">
                        <div className="review-form">
                          ...
                          <div className=" account-inner-form city-inner-form">
                            <div className="review-form-name">
                              <label htmlFor="teritory" className="form-label">
                                Town / City*
                              </label>
                        ...
                        <tr className="table-row ticket-row">
                          <td className="table-wrapper wrapper-product">
                            <div className="wrapper">
                              ...
                              <div className="wrapper-content">
                                <h5 className="heading">Hot Chicken Patties</h5>
                              </div>
                            </div>
                          </td>
                          <td className="table-wrapper">
                        ...
                        <tr className="table-row ticket-row">
                          <td className="table-wrapper wrapper-product">
                            <div className="wrapper">
                              ...
                              <div className="wrapper-content">
                                <h5 className="heading">Organic Lemon Juice</h5>
                              </div>
                            </div>
                          </td>
                          <td className="table-wrapper">
                        ...
                        <div className="product-info">
                          ...
                          <div className="product-description">
                            <a
                              ...
                              className="product-details"
                            >
                              Lemon Juice Can refresh your brain is the source of
                              vitamin C
                            </a>
                            <p className="paragraph">
                              Didn't I tell you not put your phone on charge because
              ...
              >
                <div className="support-ticket">
                  <a href="#" className="shop-btn" onclick="modalAction('.ticket')">
                    Add New Support
                  </a>
                  ...
                  <div className="modal-wrapper ticket">
                    ...
                    <div className="login-section account-section modal-main">
                      <div className="review-form">
                        ...
                        <div className=" account-inner-form">
                          <div className="review-form-name">
                            <label htmlFor="ticketaddress" className="form-label">
                              Email Address*
                            </label>
                            <input
                              type="email"
                          ...
                          <div className="review-form-name">
                            <label htmlFor="ticketphone" className="form-label">
                              Phone Number*
                            </label>
                            <input
                              type="tel"
                        ...
                        <div className="review-form-name address-form">
                          <label htmlFor="ticketmassage" className="form-label">
                            Description*
                          </label>
                          <textarea
                            name="ticketmassage"

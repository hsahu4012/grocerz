  ...
  return (
    <div className="container mx-auto max-w-md mt-8 mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mx-2'>
          <button type="submit" className="bg-blue-500 text-black px-4 py-2 rounded hover:bg-blue-600 mr-2">Save</button> 
          <button onClick={handleCancel} className="bg-gray-400 mx-2 mb-2 text-black px-4 py-2 rounded hover:bg-gray-500">Cancel</button>
        </div>
      </form>
    </div>
    </div>

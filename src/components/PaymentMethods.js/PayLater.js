...
const PayLater = () => {
  ...
  return (
    <div className="wallet-container">
      <div className="payment-method" onClick={() => handleWalletClick('iciciPayLater')}>
        <input
          className="check"
          type="radio"
          id="iciciPayLater"
      ...
      <div className="payment-method" onClick={() => handleWalletClick('freechargePayLater')}>
        <input
          className="check"
          type="radio"
      ...
      <div className="payment-method" onClick={() => handleWalletClick('flipkartPayLater')}>
        <input
          className="check"
          type="radio"
          id="flipkartPayLater"
      ...
      <div className="payment-method" onClick={() => handleWalletClick('lazyPayLater')}>
      <input
        className="check"
        type="radio"
        id="lazyPayLater"

...
const EmiPage = () => {
  ...
  return (
    <div className="wallet-container">
      <div className="payment-method" onClick={() => handleWalletClick('hdfccredit')}>
        <input
          className="check"
          type="radio"
          id="hdfccredit"
      ...
      <div className="payment-method" onClick={() => handleWalletClick('hdfcdebit')}>
      <input
        className="check"
        type="radio"
        id="hdfcdebit"
      ...
      <div className="payment-method" onClick={() => handleWalletClick('icicicredit')}>
        <input
          className="check"
          type="radio"
          id="icicicredit"
      ...
      <div className="payment-method" onClick={() => handleWalletClick('icicidebit')}>
      <input
        className="check"
        type="radio"
        id="icicidebit"
    ...
    <div className="payment-method" onClick={() => handleWalletClick('axiscredit')}>
    <input
      className="check"
      type="radio"
      id="axiscredit"

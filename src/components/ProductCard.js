    ...
    <div className='col-xl-4 col-sm-6' key={product.productid}>
                      <div className='product-wrapper m-2' data-aos='fade-up'>
                        ...
                        <Link to={`/product/${product.productid}`} className="d-block">
                            <div
                              className="p-3 rounded mt-3 mb-3 ml-3 mr-3 mx-auto d-flex justify-content-center align-items-center custom-card"                            >
                              {product.image ? (
                                <img
                                ...
                                <img
                                  src={temp_product_image}
                                  alt={product.prod_name}
                                  className="img-fluid w-100 h-100"
                                />
                              ) : (
                                <div
                                  className="border border-success d-flex justify-content-center align-items-center custom-card"
                                >
...
// <ProductCard product={product} isInCart={isInCart}/> // paste this in products 